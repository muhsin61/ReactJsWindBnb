...
export default class Search extends Component {
    ...
    getWidth = () => {
        console.log("test")
        this.setState({
            searchContainer: "searchContainer openSearchContainer",
        })
    }
    getBack = () => {
                ...
                <div className="container">
                    <div className="firstHeader">
                        ...
                        <div className="searchLogoContainer">
                            <div className="searches" onClick={() => this.getWidth()} >
                    ...
                    <div className={this.state.searchContainer}>
                        ...
                        <div className="searchContentBack" onClick={this.getBack}></div>
                    </div>
                </div>
            </div>
        )
